...
export default function LoginPage() {
  ...
  const onSubmit = async (data: LoginForm) => {
    ...
    login({ id: uuidv4(), email: data.email, name }, 'mock-jwt-token');
    setIsLoading(false);
    navigate('/dashboard');
  };
      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-8">
        <div className="flex flex-col items-center mb-8">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-2xl font-bold text-gray-900">AppHub</span>
          </div>
          <p className="text-gray-500 text-sm text-center">Build & Distribution Platform for Developers</p>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                placeholder="••••••••"
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent text-sm pr-10"
              />
              <button
                type="button"
        ...
        <p className="text-center text-xs text-gray-500 mt-6">
          Enter any email and password (min 6 chars) to get started
        </p>
      </div>
    </div>
  );
